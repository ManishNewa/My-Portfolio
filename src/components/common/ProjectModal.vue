<template>
  ...
  >
    ...
    <!-- Modal Content Wrapper (relative parent) -->
    <div class="relative z-10 w-full max-w-4xl">
      <!-- Close button -->
      <button
        @click="closeProjectModal"
        class="cursor-pointer absolute top-4 right-4 bg-white/80 border border-gray-300 backdrop-blur-sm p-2 rounded-full text-gray-800 hover:text-red-600 transition-colors z-20"
      >
